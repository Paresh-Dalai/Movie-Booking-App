...
exports.removeMoviesFromTheatre = async (req,res) => {
     ...
     try {
        ...
        if (!enteredTheatreId) {
            res.send("Please enter a Valid theatreId for removing Movie from Theatre...").status(400);
       } else {
        ...
        res.send("error occured while removing a movie from Theatre..." + error.message).status(500)
  }
